...
class ViewController: NSViewController {
    ...
    func test() {
        ...
        let listPhone = RandomList(10).phone()
        let listEmail = RandomList(10).email()
        ...
        print("listDay1", listDay1.map{$0.date})
        print("listDay2", listDay2.map{$0.date})
        print("listDay3", listDay3.map{$0.date})
        print("listDay4", listDay4.map{$0.date})
        print("listDay5", listDay5.map{$0.date})
        print("listBool", listBool)
        print("listName", listName)
        print("listCity", listCity)
        print("listState", listState)
        print("listPhone", listPhone)
        print("listEmail", listEmail)
        print("listColor", listColor.map{$0.hex})
